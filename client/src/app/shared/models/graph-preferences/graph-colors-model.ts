export class GraphColorPreferences{
    tempArColor: string = 'RGB(21, 101, 192, 1)' // blue
    tempMinColor: string = 'RGB(0, 172, 193, 1)' // light blue
    tempMaxColor: string = 'RGB(239, 108, 0, 1)' // orange
    tempOrvColor: string = 'RGB(67, 160, 71, 1)' // green
    chuvaColor: string = 'RGB(129, 212, 250, 1)' // light blue
    direcaoVentoColor: string = 'RGB(66, 66, 66, 1)'
